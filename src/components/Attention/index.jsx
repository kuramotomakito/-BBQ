...
const json2=`[{"h4":"江ノ島マリーナのご利用について","li":["開始時間の30分前から受付可能ですので、早めの受付をお願いします。","当日ブース空きがある場合は当日延長が可能です。","終了時間は完全撤収時間のため、30分前には片付けを始めていただけますよう、お願い申し上げます。"]},{"h4":"新型コロナウイルス感染症対策について","li":["食事以外の会話ではマスクの着用をお願いいたします。","マスクの着用中でも、大声を出さないようお願いいたします。"]}]`
        ...
        <dl>
            {question.map((item,index)=>{
                return(
                    <>
                    <div>
                    <dt><strong>Q:</strong>{item.Q}</dt>
                    <dd><strong>A:</strong>{item.A}</dd>
                    </div>
                    </>
                )
            })}
